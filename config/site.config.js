...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'duffdawn15@hotmail.com',
  ...
  title: "duffdawn15@hotmail.com's OneDrive",
  ...
  protectedRoutes: ['/Private', '/Demo/😎Another Private Folder Password 123', '/Documents'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:duffdawn15@hotmail.com',
